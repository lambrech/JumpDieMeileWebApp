namespace JumpDieMeileWebApp.Pages
{
    ...
    public partial class OwnMudTimePicker : MudPicker<TimeSpan?>, IAsyncDisposable
    {
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            {
                getElementByPointsHelper = await JsRuntime.InvokeAsync<IJSObjectReference>(
                    "import", "./interop.js");
            }
        }
        ...
        private async void CallJsInterop(TouchEventArgs eventArgs)
        {
            ...
            {
                var mouseOverElementId = await this.getElementByPointsHelper.InvokeAsync<string>("documentElementFromPoint", touch.ClientX, touch.ClientY).AsTask();
        ...
        async ValueTask IAsyncDisposable.DisposeAsync()
        {
            ...
            {
                await getElementByPointsHelper.DisposeAsync();
            }
        }
    }
